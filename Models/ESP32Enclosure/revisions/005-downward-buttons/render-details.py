"""Render revision005 with the desk and upward button motion made explicit.
...
def main():
    ...
    show(group(parts), revision/"preview.png", "ESP32 / downward-facing buttons",
         "Revision 005 · lid faces the floor · EN/RESET in blue · BOOT in amber")
    ...
    show(group(parts, lid=False, bracket=False), revision/"interior.png", "ESP32 / inverted internal assembly",
         "Lid removed downward · board clamps and actuator contact positions preserved", elevation=-48)
    ...
    show(group(print_layout(model["parts"])), revision/"print-layout.png", "ESP32 / 15 printable parts",
         "New bracket and extended paddles · remaining parts retain revision 004 geometry",
