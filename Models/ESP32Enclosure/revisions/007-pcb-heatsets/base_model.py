"""Revision007 base: revision006 with reinforced heat-set PCB-clamp joints.
...
def build_console(params: dict) -> dict:
    ...
    return {
        ...
        "notes": [
            ...
            "Cavity, PCB capture strips, lid skirt and mounting interfaces retain the earlier layout; revision007 moves PCB clamp screw axes outward0.4 mm. The default belt adds2.4 mm overall length.",
