"""Render actual revision009 geometry and illustrative cable/tie routing."""
...
def main():
    ...
    render(grouped(parts),output/'preview.png','ESP32 / cable retention',
           'Revision 009 · rounded cable support and zip-tie passage · body replacement only',-25,-145)
    scene=grouped(parts)
    ...
    render(grouped(exploded),output/'exploded.png','Enclosure / assembly access',
           'Lid lowered for illustration · all fourteen other revision008 parts remain compatible',-25,-145)
    render(grouped(print_layout(model['parts'])),output/'print-layout.png','Revision 009 / 15 printable parts',
           'Reprint body only · reuse the other fourteen revision008 parts',52,-65)
    ...
    render(section | refs,output/'cable-routing.png','Cable and zip-tie routing / provisional fit',
           'Provisional cable and loose tie/head envelopes · not printable hardware',32,-65)
