"""Render actual revision 012 geometry and illustrative cable/tie routing."""
...
def main():
    ...
    render(grouped(parts),output/'preview.png','ESP32 / easier board fit',
           'Revision 012 · 0.5 mm wider fit · 0.5 mm deeper board capture',-25,-145)
    scene=grouped(parts)
    ...
    render(grouped(parts,lid=False,bracket=False),output/'interior.png','Cable retention / lid removed',
           'Actual assembled geometry · concave cradle at the end opening',-48,-145)
    ...
    render(grouped(print_layout(model['parts'])),output/'print-layout.png','Revision 012 / 15 printable parts',
