"""Revision006: replace revision005's four lid nuts with M3x5 heat-set inserts.

Only the body's four lid-post cuts change. The other fourteen printed parts,
including the lid, remain unchanged in this fifteen-part set.
The revision005 desk transform, PCB and button positions remain unchanged.
...
def build(params:dict)->dict:
    ...
    mapping={'rotation_x_degrees':180.0,'translation_xyz_mm':[0.,0.,ceiling],
             ...
             'source_frame':'Revision005 case coordinates; revision006 changes only the four lid-post cuts',
    ...
    result['title']='ESP32 / lid heat-set compatibility update · revision006'
    ...
    result['notes']=[
        ...
        f'The existing bracket uses four M3x{insert_length:g} heat-set inserts. Its M3x10 screws pass upward through the flipped 5 mm ears for {insert_engagement:g} mm nominal insert engagement and {insert_depth-5:g} mm blind-tip clearance. The four archived PCB-clamp nuts remain unchanged; lid nuts are removed in this revision.',
