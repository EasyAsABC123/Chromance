"""Render actual revision011 geometry and illustrative cable/tie routing."""
...
def main():
    ...
    render(grouped(parts),output/'preview.png','ESP32 / narrower enclosure',
           'Revision 011 · 3 mm narrower · concave cradle for 8 mm cable',-25,-145)
    scene=grouped(parts)
    ...
    render(grouped(exploded),output/'exploded.png','Enclosure / assembly access',
           'Lid lowered for illustration · replace body, lid and desk bracket together',-25,-145)
    render(grouped(print_layout(model['parts'])),output/'print-layout.png','Revision 011 / 15 printable parts',
           'Body, lid and bracket change; verify fit with the new coupons',52,-65)
