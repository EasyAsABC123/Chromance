"""Freeze all local CAD modules before exporting a fresh measured-button revision013."""
import argparse
import hashlib
import json
...
def main():
    ...
    with tempfile.TemporaryDirectory(prefix="measured-button-sources-") as tmp:
        snapshot = Path(tmp)
        for name in sources:
