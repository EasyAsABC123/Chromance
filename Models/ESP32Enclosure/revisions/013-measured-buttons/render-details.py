"""Render actual revision 013 geometry and illustrative cable/tie routing."""
...
def main():
    ...
    render(grouped(parts),output/'preview.png','ESP32 / easier board fit',
           'Revision 013 · Measured button centers · replaceable dogleg sliders',-25,-145)
    scene=grouped(parts)
    ...
    render(grouped(parts,lid=False,bracket=False),output/'interior.png','Measured button arms / lid removed',
           'Actual assembled geometry · revised RESET and BOOT sliders',-48,-145)
    ...
    render(grouped(print_layout(model['parts'])),output/'print-layout.png','Revision 013 / 15 printable parts',
           'Width and capture interfaces change; verify with the board-fit coupon',52,-65)
