"""Revision 013: measured switch centers with replaceable dogleg sliders.

Independent exterior guide positions preserve revision 012 mounting geometry.
Straight tongues clear the guides before bending toward measured PCB datums.
Board retention, cable cradle and all thirteen other printed parts are retained.
"""
...
def build(params:dict)->dict:
    ...
    result['measurements']['button_alignment'] = {
        ...
        'fit_test': 'fit-tests/008-button-alignment',
    }
    result['title']='ESP32 / measured button centers and dogleg sliders · revision013'
    ...
    result['notes']=[
        ...
        f'The lid and extended finger pads face downward when mounted; press upward through {p["button_stroke"]:g} mm nominal travel. Desk contact remains at Z{desk_z:g}; the bracket and all mounting positions are unchanged from012.',
