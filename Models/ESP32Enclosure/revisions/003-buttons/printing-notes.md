...
- Additional hardware: four M3x18 socket screws (head diameter<=5.5 mm), four short M3 heat-set inserts (nominal length4 / OD4.6 mm), four 4x2 mm magnets, one nylon M3x10 EN contact screw, one nylon M3x10 BOOT contact screw and four nylon M3 nuts. No mounting washers are assumed.
