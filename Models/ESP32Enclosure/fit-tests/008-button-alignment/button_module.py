...
def make_button(params=None, name="button"):
    ...
    # full upper boss stay intact. Actual USB plug dimensions are unmeasured.
    ...
    return {
        ...
        "notes": [
            ...
            "Only the collar below the arm is relieved toward the other switch; retain at least 1.2 mm around the M3 passage. The upper insert boss and material directly below the pilot remain intact. Actual USB plug clearance requires a physical fit test.",
