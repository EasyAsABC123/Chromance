...
def build(params: dict) -> dict:
    ...
    result["notes"].extend([
        ...
        "Exterior housings retain an 11 mm gap at the default positions; the inboard connector envelope differs with measured tip positions. Fit the USB plug before the cartridges and verify its actual clearance.",
