...
- Measure the 50.3 mm locating gap and 46.4 mm gap between inner shelf faces at both front/rear pairs. Capture slot is 1.2 mm high, leaving 0.2 mm vertical play.
- Shelves and matching upper clamps overlap the centered PCB by 1.3 mm. Minimum overlap after full lateral movement is 0.65 mm. Verify this wider contact strip is bare board on both faces.
