...
def main():
    ...
    preview.render(model['assembly'],out/'preview.png',title='49 mm board fit / narrower retention',subtitle='Exact revision011 lower frame · four M3x5 insert / M3x6 screw clamps',elevation=52,azimuth=-65)
    ...
    preview.render(model['assembly']|{'reference_pcb':model['reference_pcb']},out/'fit-reference.png',title='49 × 70 × 1 mm PCB / fit reference',subtitle='Bare substrate shown only · check real solder, components and 52 mm populated span',elevation=52,azimuth=-65)
