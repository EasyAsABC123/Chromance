"""Extract revision010's actual cable anchor, exit wall and lid into a quick fit print."""
...
def build(params):
    ...
    return {
        ...
        'title':'8 mm cable / quick fit test 004',
        'reference_geometry':refs,
        'coupon_crop_local':crop,
        'full_model':full,
        'measurements':{
            'source_revision':'010-8mm-cable',
        ...
        'notes':[
            'Quick iterative fit print extracted from the full revision010 source and parameters at true scale; previous fit tests remain preserved.',
