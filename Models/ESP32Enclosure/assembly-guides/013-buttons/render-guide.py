...
Run from the packaged workbench: python assembly-guides/013-buttons/render-guide.py
...
def main():
    ...
    parser.add_argument('--source',type=Path,default=here.parents[1]/'revisions/013-measured-buttons')
    ...
    manifest={'source_revision':source.name,'source_path_from_guide':os.path.relpath(source,output),
        ...
        'images':['01-reset-exploded.png','02-reset-cutaway.png','03-slider-comparison.png']+(['04-button-alignment.png'] if align_info else []),
